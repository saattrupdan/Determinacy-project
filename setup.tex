...
% User-defined commands
  ...
  \newcommand{\cproof}[1]{
    \begin{adjustwidth}{0.5cm}{0pt}
      \textsc{Proof of claim.} #1$\hfill\diamondsuit$\\
    \end{adjustwidth}}
  \renewcommand{\qed}{\hfill\blacksquare}
  \newcommand{\qedeq}{\tag*{$\blacksquare$}}

  % Declared operators
  \DeclareMathOperator{\acc}{\text{acc}}
  \DeclareMathOperator{\blad}{\textsf{Bl-AD}}
  \DeclareMathOperator{\kb}{<_{\text{KB}}}
  ...
  \DeclareMathOperator{\ac}{\textsf{AC}}
  ...
  \DeclareMathOperator{\n}{\mathcal{N}}
  \DeclareMathOperator{\tree}{{^{<\omega}\omega}}
  ...
  \newcommand{\limm}{\varinjlim}
  \newcommand{\colimm}{\varprojlim}
